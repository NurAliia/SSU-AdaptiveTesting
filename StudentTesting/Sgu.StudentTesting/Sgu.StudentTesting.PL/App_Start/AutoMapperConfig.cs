        ...
        public static void RegisterMaps()
        {
            Mapper.Initialize(cfg =>
            {
                ...
                cfg.CreateMap<UserCreateVM, User>()
                    ...
                    .ForMember(dest => dest.CurrentComplexity, opt => opt.Ignore())
                    .ForMember(dest => dest.ResultFrequency, opt => opt.Ignore())
                    .ForMember(dest => dest.ResultTest, opt => opt.Ignore())
                    .ForMember(dest => dest.AnsweredQuestionsList, opt => opt.Ignore());
